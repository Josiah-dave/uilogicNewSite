          ...
          <div className="row gap-60">
            <div className="col-lg-8">
              {blogs.map((blogElement, index) => (
                <div
                  className="blog-details-content wow fadeInUp delay-0-2s"
                  key={index}
                >
                  <div className="image mb-40">
                    <img src={blogElement.blog.blogImg} alt="Blog Single" />
                  </div>
                  <div className="blog-meta-two pb-15">
                    <Link legacyBehavior href="/blog">
                      <a className="tag">{blogElement.blog.blogCategory}</a>
                    </Link>
                    <Link legacyBehavior href="/blog">
                      <a className="author">{blogElement.blog.author}</a>
                    </Link>
                    <a className="date" href="#">
                      <i className="far fa-calendar-alt" />{" "}
                      {blogElement.blog.blogDate}
                    </a>
                  </div>
                  <div className="title mb-20">
                    <h3>{blogElement.blog.blogTitle}</h3>
                  </div>
                  <p>{blogElement.blog.blogParagraph}</p>
                  ...
                  <p>{blogElement.blog.blogParagraghTwo}</p>
                  <blockquote>
                    <div className="content">
                      <h4>
                        Smashing Podcast Episode Pauloag Conve Seen Overs
                        Analyze And Compare Performance Frameworks
                      </h4>
                  ...
                  <div className="image mt-60 mb-30">
                    <img
                      src={blogElement.blog.blogHeadingImg}
                      alt="Blog Details"
                    />
                  </div>
                  <h4>{blogElement.blog.blogHeading}</h4>

                  <p>{blogElement.blog.blogParagraphThree}</p>

                  <p>{blogElement.blog.blogParagraphFour}</p>
                  <div className="image mt-60 mb-30">
                    <img
                      src={blogElement.blog.blogHeadingTwoImg}
                      alt="Blog Details"
                    />
                  </div>
                  <h4>{blogElement.blog.blogHeadingTwo}</h4>
                  <p>{blogElement.blog.blogParagraphFive}</p>
                  <h4>{blogElement.blog.blogHeadingFour}</h4>
                  <p>{blogElement.blog.blogParagraphSix}</p>
                  <div className="image mt-60 mb-30">
                    <img
                      src={blogElement.blog.blogHeadingFiveImg}
                      alt="Blog Details"
                    />
                  </div>
                  <h4>{blogElement.blog.blogHeadingFive}</h4>
                  <p>{blogElement.blog.blogParagraphSeven}</p>
                </div>
              ))}
